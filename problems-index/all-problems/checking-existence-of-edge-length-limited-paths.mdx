...
Suppose, dist=2, component = &lbrace;a,b,c&rbrace;
dist=5, component = &lbrace;a,b,c,z&rbrace;
dist=7, component = &lbrace;a,b,c,z&rbrace;  &lbrace;x,y&rbrace;
dist= 8, component = &lbrace;a,b,c,x,y,z&rbrace; and so on.
