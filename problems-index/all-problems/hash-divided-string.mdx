...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Hash Divided String" lines
# @param {String} s
# @param {Integer} k
# @return {String}
def string_hash(s, k)
