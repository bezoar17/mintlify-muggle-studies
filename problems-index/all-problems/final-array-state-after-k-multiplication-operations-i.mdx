...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Final Array State After K Multiplication Operations I" lines
# @param {Integer[]} nums
# @param {Integer} k
