...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Minimum Operations to Make Binary Array Elements Equal to One I" lines
# @param {Integer[]} nums
# @return {Integer}
