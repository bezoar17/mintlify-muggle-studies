...
So, we can take advantage of this to seat more people on their either side. But if there are 2 acyclic chains, 1 ending at a1, say AC1&lbrace; wb1-&gt;wb2-&gt;a1 &rbrace; and 1 ending at a2 say, AC2&lbrace; wb3-&gt;wb4-&gt;a2 &rbrace;
