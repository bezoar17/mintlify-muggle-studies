...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Merge Two 2D Arrays by Summing Values" lines
# @param {Integer[][]} nums1
# @param {Integer[][]} nums2
# @return {Integer[][]}
