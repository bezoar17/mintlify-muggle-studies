...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Node With Highest Edge Score" lines
# @param {Integer[]} edges
# @return {Integer}
