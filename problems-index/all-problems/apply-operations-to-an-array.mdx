...
<Tabs>
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Apply Operations to an Array" lines
# @param {Integer[]} nums
# @return {Integer[]}
