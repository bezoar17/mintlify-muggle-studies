...
Till this point, just keep track of edge weights, and pick max out of them.
  ...
  <Expandable title="code">
    <CodeGroup dropdown>
```ruby title="Minimize Maximum Component Cost" lines
# @param {Integer} n
# @param {Integer[][]} edges
# @param {Integer} k
# @return {Integer}
