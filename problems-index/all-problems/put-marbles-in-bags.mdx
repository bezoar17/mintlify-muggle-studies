...
<Tabs>
  ...
  <Tab title="Solution" icon="lightbulb" iconType="regular" >
    <Card>
      weights needs to be split in k subarrays, so k-1 split points. Each split point at i contributes i, i+1 to weights. So, in a max config, we have highest k-1 values for &lbrace;i,i+1&rbrace; pairs, and in min config, the lowest k-1 values.
